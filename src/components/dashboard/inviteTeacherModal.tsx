    ...
    return (
        <Modal open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <ModalContent size="lg" className="bg-surface border-black/10 p-0 scrollbar-hidden">
                ...
                <ModalFooter className="p-2 bg-black/5 flex justify-end">
                    <button
                        onClick={onClose}
                        className="px-6 py-3 rounded-xl border border-black/10 text-[13px] font-bold text-text hover:bg-black/5 transition-all"
                    >
                        Done
                    </button>
                </ModalFooter>
