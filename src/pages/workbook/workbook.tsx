                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-black/5">
                    <div className="flex items-center gap-5">
                        <button
                            ...
                            className="h-10 w-10 flex items-center justify-center rounded-xl bg-surface border border-black/5 text-text-mid hover:text-text hover:border-black/10 transition-all"
                        >
